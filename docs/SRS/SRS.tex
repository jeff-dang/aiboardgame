...
\begin{itemize}
    ...
    \item $q_1$ The state after the game has began and will be looping through continuously until the game has concluded.
    \item $q_2$ The final state afterwards the winning move is made in the game and concludes the system.
