...
# the actions in this file are related to the action tokens
# some actions are commented out in an effort to decrease the AI training time by simplifying the game
