...
class PieChart:
    def __init__(self, jsonInput, explode, chartTitle, pngFilePath, objectName):
        self.jsonInput = jsonInput
        self.explode = explode
        self.chartTitle = chartTitle
        self.pngFilePath = pngFilePath
    ...
    def get_pieChart(self):
        ...
        plt.pie(winRate, labels=position, explode=explode, shadow=True,
                ...
                wedgeprops={'edgecolor': 'pink'})

        plt.title(chartTitle)
        plt.tight_layout()
        plt.savefig('tic-tac-toe-PieChart2.png')
        plt.show()

p1 = JSONParser("tic-tac-toe_json.json")

pc1 = PieChart(p1.get_jsonOutput(),[0, 1, 0],"tictactoe Winrate PieChart")
pc1.get_pieChart()
