...
class Engine:
    ...
    def play_turn(self, agent_name: str, action):
        ...
        Logger.log('Current monument is: ' + str(self.monuments[self.monument_index].name) + ' index is: ' + str(self.monument_index) +
                   ' num walls completed ' + str(self.monuments[self.monument_index].get_num_walls_completed()), 'GAME_ENGINE_LOGS')
