...
THE_LIBRARY_OF_VALDUIN = Monument(
    ...
    [
        ...
        MonumentWall(
            [Energy.CONSTRUCTIVE, Energy.GENERATIVE, Energy.GENERATIVE], [Energy.PRIMAL]
        ),
        # TODO: Need a mechanism to handle any energy reward
        MonumentWall([Energy.INVERTIBLE, Energy.GENERATIVE], ["Any"]),
    ],
)
THE_ERIDONIC_GATE = Monument(
    "THE ERIDONIC GATE",
    Map_Areas.QUARRY,
    [
        MonumentWall(
...
THE_NAMARILLION_FORGE = Monument(
    ...
    [
        ...
        MonumentWall(
            [Energy.CONSTRUCTIVE, Energy.INVERTIBLE, Energy.GENERATIVE], [Energy.PRIMAL]
        ),
        MonumentWall(
            [Energy.GENERATIVE, Energy.INVERTIBLE, Energy.INVERTIBLE],
            [Energy.CONSTRUCTIVE],
...
THE_FORTRESS_OF_KOLYM_THRIN = Monument(
...
THE_SHIP_OF_TOLINTHRA = Monument(
...
MONUMENTS = [
    THE_ANFIRIEN_BEACON,
    THE_LIBRARY_OF_VALDUIN,
    THE_ERIDONIC_GATE,
    THE_NAMARILLION_FORGE,
    THE_FORTRESS_OF_KOLYM_THRIN,
    THE_SHIP_OF_TOLINTHRA,
]
